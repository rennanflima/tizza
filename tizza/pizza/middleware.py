...
class RateLimitMiddleware:
    """"
    Middleware para limitar o número de chamadas no oriundas do mesmo endereço IP em um determinado período,
    com um número especificado nas configurações do Projeto
    """
